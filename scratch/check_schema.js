...
async function checkSchema() {
  console.log('Intentando insertar un registro con un campo inventado para forzar un error descriptivo...');
  const { error } = await supabase.from('documents').insert({ x_non_existent_column: 'test' });
  console.log('Error de Supabase (aquí deberíamos ver las columnas válidas):', error);
}
