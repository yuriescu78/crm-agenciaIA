...
- Name: tests/09-bot-agent.spec.ts >> Bot Agent — Evaluación funcional >> [T02] tareas: "Crea tarea "Revisar propuesta BotTest" con prioridad Alta"
- Location: tests/tests/09-bot-agent.spec.ts:196:9

# Error details

```
Error: Esperaba patrón /creada|Revisar propuesta|correcta/i en la respuesta del bot

expect(received).toMatch(expected)

Expected pattern: /creada|Revisar propuesta|correcta/i
