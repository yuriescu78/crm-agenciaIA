...
- Name: tests/09-bot-agent.spec.ts >> Bot Agent — Evaluación funcional >> [S03] saludo: "Buenos días"
- Location: tests/tests/09-bot-agent.spec.ts:196:9

# Error details

```
Error: Esperaba patrón /cliente|tarea|reunión|resumen|día/i en la respuesta del bot

expect(received).toMatch(expected)

Expected pattern: /cliente|tarea|reunión|resumen|día/i
