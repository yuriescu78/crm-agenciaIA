...
- Name: tests/09-bot-agent.spec.ts >> Bot Agent — Evaluación funcional >> [T03] tareas: "Qué tareas urgentes tengo"
- Location: tests/tests/09-bot-agent.spec.ts:196:9

# Error details

```
Error: Esperaba patrón /alta|urgente|no hay|tarea/i en la respuesta del bot

expect(received).toMatch(expected)

Expected pattern: /alta|urgente|no hay|tarea/i
