...
- Name: tests/09-bot-agent.spec.ts >> Bot Agent — Evaluación funcional >> [E02] calendario: "Agenda reunión con Test el viernes a las 15h"
- Location: tests/tests/09-bot-agent.spec.ts:196:9

# Error details

```
Error: Esperaba patrón /creado|agendad|reunión|viernes|calendario/i en la respuesta del bot

expect(received).toMatch(expected)

Expected pattern: /creado|agendad|reunión|viernes|calendario/i
