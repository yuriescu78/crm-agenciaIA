...
- Name: tests/09-bot-agent.spec.ts >> Bot Agent — Evaluación funcional >> [C02] busqueda: "Busca el cliente AC2"
- Location: tests/tests/09-bot-agent.spec.ts:196:9

# Error details

```
Error: Esperaba patrón /AC2|Innovaci|encontr|resultado/i en la respuesta del bot

expect(received).toMatch(expected)

Expected pattern: /AC2|Innovaci|encontr|resultado/i
