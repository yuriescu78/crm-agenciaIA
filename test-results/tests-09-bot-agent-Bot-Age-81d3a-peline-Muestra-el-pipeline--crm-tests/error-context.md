...
- Name: tests/09-bot-agent.spec.ts >> Bot Agent — Evaluación funcional >> [P01] pipeline: "Muestra el pipeline"
- Location: tests/tests/09-bot-agent.spec.ts:196:9

# Error details

```
Error: Esperaba patrón /oportunidad|pipeline|etapa|contacto/i en la respuesta del bot

expect(received).toMatch(expected)

Expected pattern: /oportunidad|pipeline|etapa|contacto/i
