...
- Name: tests/09-bot-agent.spec.ts >> Bot Agent — Evaluación funcional >> [T01] tareas: "Muestra mis tareas pendientes"
- Location: tests/tests/09-bot-agent.spec.ts:196:9

# Error details

```
Error: Esperaba patrón /tarea|pendiente|no hay|lista/i en la respuesta del bot

expect(received).toMatch(expected)

Expected pattern: /tarea|pendiente|no hay|lista/i
