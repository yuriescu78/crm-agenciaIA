...
- Name: tests/09-bot-agent.spec.ts >> Bot Agent — Evaluación funcional >> [C03] clientes: "Crea cliente PruebaBot empresa BotCorp email bot@test.com"
- Location: tests/tests/09-bot-agent.spec.ts:196:9

# Error details

```
Error: Esperaba patrón /creado|PruebaBot|correcta/i en la respuesta del bot

expect(received).toMatch(expected)

Expected pattern: /creado|PruebaBot|correcta/i
