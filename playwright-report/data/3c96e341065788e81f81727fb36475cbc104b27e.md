...
- Name: tests/01-dashboard.spec.ts >> Dashboard >> los links de navegación funcionan
- Location: tests/tests/01-dashboard.spec.ts:27:7
...
Locator: locator('nav, [class*="sidebar"], [class*="menu"]').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('nav, [class*="sidebar"], [class*="menu"]').first()
