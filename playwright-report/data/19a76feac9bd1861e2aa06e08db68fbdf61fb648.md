...
- Name: tests/09-bot-agent.spec.ts >> Bot Agent — Evaluación funcional >> [X02] clientes: "Cuántos clientes tengo"
- Location: tests/tests/09-bot-agent.spec.ts:196:9

# Error details

```
Error: Esperaba patrón /\d+|client/i en la respuesta del bot

expect(received).toMatch(expected)

Expected pattern: /\d+|client/i
