...
- Name: tests/09-bot-agent.spec.ts >> Bot Agent — Evaluación funcional >> [X01] saludo: "Dame un resumen del día"
- Location: tests/tests/09-bot-agent.spec.ts:196:9

# Error details

```
Error: Esperaba patrón /cliente|tarea|reunión|resumen|hoy/i en la respuesta del bot

expect(received).toMatch(expected)

Expected pattern: /cliente|tarea|reunión|resumen|hoy/i
