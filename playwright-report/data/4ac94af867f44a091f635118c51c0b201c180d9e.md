...
- Name: tests/09-bot-agent.spec.ts >> Bot Agent — Evaluación funcional >> [C01] clientes: "Lista mis clientes"
- Location: tests/tests/09-bot-agent.spec.ts:196:9

# Error details

```
Error: Esperaba patrón /client|nombre|empresa/i en la respuesta del bot

expect(received).toMatch(expected)

Expected pattern: /client|nombre|empresa/i
