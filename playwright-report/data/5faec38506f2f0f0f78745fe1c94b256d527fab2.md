...
- Name: tests/09-bot-agent.spec.ts >> Bot Agent — Evaluación funcional >> [E01] calendario: "Qué reuniones tengo hoy"
- Location: tests/tests/09-bot-agent.spec.ts:196:9

# Error details

```
Error: Esperaba patrón /reunión|evento|no hay|hoy|agenda/i en la respuesta del bot

expect(received).toMatch(expected)

Expected pattern: /reunión|evento|no hay|hoy|agenda/i
